	...
	<div class="max-w-[1480px] mx-auto px-4 sm:px-6 w-full justify-center items-center flex flex-col">
		...
		>
			...
			<div class="w-full text-center md:text-left">
				<h3 class="text-gray-400 text-lg sm:text-xl md:text-2xl font-semibold mb-4">Quick Links</h3>
				<ul class="space-y-3">
					<li>
						<a
							href="#"
							class="text-white hover:text-blue-500 transition-colors duration-200 text-base sm:text-lg md:text-xl"
							>IDID Registration</a
						>
					</li>
					<li>
			...
			<div class="w-full text-center md:text-left">
				<h3 class="text-gray-400 text-lg sm:text-xl md:text-2xl font-semibold mb-4">Contact Us</h3>
				<ul class="space-y-3">
					<li>
						<a
							href="#"
		...
		<div class="border-t border-gray-800 mt-12 pt-8 text-center">
			<p class="text-gray-500 text-base md:text-lg">
				© 2026 Paradise Games - UNICAL. All rights reserved.
			</p>
			<ul
				class="text-gray-500 text-base md:text-lg flex gap-3 md:gap-4 flex-wrap justify-center mt-4"
			>
